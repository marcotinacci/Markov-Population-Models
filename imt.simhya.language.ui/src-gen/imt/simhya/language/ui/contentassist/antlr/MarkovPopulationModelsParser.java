		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLocal_rateAccess().getAlternatives(), "rule__Local_rate__Alternatives");
					...
					put(grammarAccess.getLocal_rateAccess().getConstRefAssignment_0(), "rule__Local_rate__ConstRefAssignment_0");
					put(grammarAccess.getLocal_rateAccess().getLocalRateAssignment_1(), "rule__Local_rate__LocalRateAssignment_1");
