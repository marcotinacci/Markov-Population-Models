 ...
 *   <li>{@link imt.simhya.language.markovPopulationModels.state#getParamList <em>Param List</em>}</li>
...
public interface state extends EObject
{
   ...
   * @see imt.simhya.language.markovPopulationModels.MarkovPopulationModelsPackage#getstate_ParamList()
  ...
  /**
   * Sets the value of the '{@link imt.simhya.language.markovPopulationModels.state#getParamList <em>Param List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
